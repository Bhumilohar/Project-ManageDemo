  ...
  return (
    <>
      ...
      {/*<div className="my-2 mx-auto max-w-[700px] py-4">*/}
        {tasks.length !== 0 && <h2 className='my-2 ml-2 md:ml-0 text-xl'>Your Project </h2>}
        {loading ? (
          <Loader />
        ) : (
          <div>
            {tasks.length === 0 ? (
              ...
              <div className='w-[400px] h-[300px] flex items-center justify-center gap-4'>
                <span>Start Now</span>
                <Link to="/tasks/add" className="bg-blue-500 text-white hover:bg-blue-600 font-medium rounded-md px-4 py-2"> Add New </Link>
              </div>
